...
trainingset <- read.csv("C:/Niraj/Tech Docs/Coursera/Data Science/John Hopkins/8. Practical Machine Learning/Course Project/pml-training.csv", na.strings=c("NA","#DIV/0!", ""))

# Loading the testing data set 
testingset <- read.csv('C:/Niraj/Tech Docs/Coursera/Data Science/John Hopkins/8. Practical Machine Learning/Course Project/pml-testing.csv', na.strings=c("NA","#DIV/0!", ""))
